...
android {
    namespace = "com.canride.passenger"
    ...
    defaultConfig {
        ...
        applicationId = "com.canride.passenger"
        ...
        // com.canride.passenger + SHA-1. Server/IP or browser/referrer-only
        ...
        val resolvedMapsKey =
            mapsProps.getProperty("GOOGLE_MAPS_API_KEY_ANDROID")
                ...
                ?: localProps.getProperty("GOOGLE_MAPS_API_KEY_ANDROID")
