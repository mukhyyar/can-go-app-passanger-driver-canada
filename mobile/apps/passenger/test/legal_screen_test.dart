...
void main() {
  group('Passenger Legal and Policies Tests', () {
    testWidgets('LegalScreen renders Privacy Policy and switches to Terms of Service',
        (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: const LegalScreen(initialSlug: 'privacy'),
          ),
        ),
      );
    ...
    testWidgets('AuthScreen displays interactive policy links in footer',
        (tester) async {
